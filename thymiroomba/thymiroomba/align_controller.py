...
class ThymioState(Enum):
    ...
    FORWARD = 1
    # Once the wall is in range of the front sensors, blindly turn until it becomes in range of the rear sensors
    TURNING = 2
...
class AlignController(ControllerNode):
    ...
    def init_backward(self):
        ...
        # The target pose is 2m from the wall, perpendicularly:
